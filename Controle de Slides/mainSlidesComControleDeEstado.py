...
class HandGestureController:
    def __init__(self):
        ...
        self.control_slides_active = False
        self.slide_advance_threshold = 200  
        self.slide_backward_threshold = 100  
    ...
    def run(self):
        ...
        while cap.isOpened():
            ...
            if hand_detected:
                ...
                if not self.control_slides_active:
                    self.control_slides_active = True
                    print("Iniciando controle de slides!")

            else:
                if self.control_slides_active:
                    self.control_slides_active = False
            ...
            if self.control_slides_active:
                ...
                if hand_position and len(hand_position) >= 5:
                    ...
                    if hand_x > self.screen_width - self.slide_advance_threshold:
                        ...
                        time.sleep(1)  # Adiciona um pequeno atraso para evitar ações consecutivas

                    elif hand_x < self.slide_backward_threshold:
